  ...
  render () {
    ...
    return (
      <ReflexElement size={this.state.size} {...this.props}>
        <div className="pane-content" ref={this.containerRef}>
...
/////////////////////////////////////////////////////////
ReactDOM
  .createRoot(document.getElementById('demo-basic'))
  .render(<ReflexBasicDemo/>)

ReactDOM
  .createRoot(document.getElementById('demo-basic-splitter'))
  .render(<ReflexBasicSplitterDemo/>)

ReactDOM
  .createRoot(document.getElementById('demo-splitter-propagation-2x'))
  .render(<ReflexSplitterPropagationDemo2x/>)

ReactDOM
  .createRoot(document.getElementById('demo-splitter-propagation-3x'))
  .render(<ReflexSplitterPropagationDemo3x/>)

ReactDOM
  .createRoot(document.getElementById('demo-advanced'))
  .render(<ReflexAdvancedDemo/>)

ReactDOM
  .createRoot(document.getElementById('demo-controls'))
  .render(<ReflexControlsDemo/>)

ReactDOM
  .createRoot(document.getElementById('demo-size-aware'))
  .render(<ReflexSizeAwareDemo/>)

ReactDOM
  .createRoot(document.getElementById('demo-storage'))
  .render(<ReflexStorageDemo/>)

ReactDOM
  .createRoot(document.getElementById('demo-collapse'))
  .render(<ReflexCollapseDemo/>)

ReactDOM
  .createRoot(document.getElementById('demo-handle'))
  .render(<ReflexHandleDemo/>)
